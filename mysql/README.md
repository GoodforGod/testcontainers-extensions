...
[![Maven Central](https://img.shields.io/maven-central/v/io.goodforgod/testcontainers-extensions-mysql.svg)](https://central.sonatype.com/artifact/io.goodforgod/testcontainers-extensions-mysql)
...
**Gradle**
```groovy
testImplementation "io.goodforgod:testcontainers-extensions-mysql:0.13.0"
```
