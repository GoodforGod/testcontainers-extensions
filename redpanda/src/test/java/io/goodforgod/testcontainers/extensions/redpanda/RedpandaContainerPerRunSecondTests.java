...
class RedpandaContainerPerRunSecondTests {
    ...
    void firstConnection(@ConnectionRedpanda RedpandaConnection connection) {
        ...
        if (RedpandaContainerPerRunFirstTests.perRunConnection != null) {
            assertEquals(perRunConnection, RedpandaContainerPerRunFirstTests.perRunConnection);
        }
