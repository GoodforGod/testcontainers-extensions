...
@interface TestcontainersClickhouse {
     ...
     *             <p>
     *             1) Image can have static value: "clickhouse/clickhouse-server:24.9-alpine"
     ...
     *             "${MY_IMAGE_ENV|clickhouse/clickhouse-server:24.9-alpine}"
     */
    String image() default "clickhouse/clickhouse-server:24.9-alpine";
