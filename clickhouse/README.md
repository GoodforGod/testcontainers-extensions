...
[![Maven Central](https://img.shields.io/maven-central/v/io.goodforgod/testcontainers-extensions-clickhouse.svg)](https://central.sonatype.com/artifact/io.goodforgod/testcontainers-extensions-clickhouse)
...
**Gradle**
```groovy
testImplementation "io.goodforgod:testcontainers-extensions-clickhouse:0.15.0"
```
