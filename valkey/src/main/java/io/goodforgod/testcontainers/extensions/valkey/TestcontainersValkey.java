...
/**
 * Extension that is running {@link ValkeyContainer} for tests in different modes with database
...
public @interface TestcontainersValkey {

    /**
     * @return Valkey image
     *             <p>
     *             1) Image can have static value: "valkey/valkey:8.1-alpine"
     ...
     *             "${MY_IMAGE_ENV|valkey/valkey:8.1-alpine}"
     */
    String image() default "valkey/valkey:8.1-alpine";
