...
class NatsContainerPerRunSecondTests {
    ...
    void firstConnection(@ConnectionNats NatsConnection connection) {
        ...
        if (NatsContainerPerRunFirstTests.perRunConnection != null) {
            assertEquals(perRunConnection, NatsContainerPerRunFirstTests.perRunConnection);
        }
