...
@TestcontainersNats(mode = ContainerMode.PER_METHOD)
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
@TestInstance(TestInstance.Lifecycle.PER_METHOD)
class NatsContainerPerMethodConstructorTests {

    private final NatsConnection sameConnection;

    private static NatsConnection firstConnection;

    NatsContainerPerMethodConstructorTests(@ConnectionNats NatsConnection sameConnection) {
