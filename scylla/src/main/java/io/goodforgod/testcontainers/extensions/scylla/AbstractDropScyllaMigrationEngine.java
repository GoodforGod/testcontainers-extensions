...
abstract class AbstractDropScyllaMigrationEngine implements ScyllaMigrationEngine {
    ...
    protected final ScyllaConnection connection;

    public AbstractDropScyllaMigrationEngine(ScyllaConnection connection) {
