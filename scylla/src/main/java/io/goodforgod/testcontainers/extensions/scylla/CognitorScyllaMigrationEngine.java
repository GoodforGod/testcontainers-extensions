...
public final class CognitorScyllaMigrationEngine extends AbstractDropScyllaMigrationEngine {

    public CognitorScyllaMigrationEngine(ScyllaConnection connection) {
        super(connection);
    }
